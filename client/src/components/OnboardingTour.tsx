...
const onboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    ...
    icon: <AttachMoney />,
    content: [
      'В разделе "Платежи" фиксируйте все платежи от клиентов.',
      'Создавайте тарифы (абонементы) в разделе "Тарифы".',
      'Выдавайте тарифы клиентам в разделе "Выданные тарифы".',
      'Тарифы автоматически используются при посещении тренировок.',
      'Все платежи учитываются в статистике на Dashboard.',
    ],
  },
  {
    title: 'Настройки',
